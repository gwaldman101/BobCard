...
class StudentEntry(models.Model):
    ...
    net_id = models.ForeignKey("Student", on_delete=models.CASCADE) # if student gets deleted we delete this as well
    ...
    def __str__(self):
        ...
        return '{0} ({1})'.format(self.net_id, self.requested_location)
